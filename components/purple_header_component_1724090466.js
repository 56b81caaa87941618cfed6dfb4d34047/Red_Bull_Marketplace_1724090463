...
Vue.component("purple_header_component_1724090466", {
    template: '<header class="w-full z-30" id="header-section-container">\
    ...
    \
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">\
                        ...
                        <li><a id="Events-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Events.html">Events</a></li>\
                        <li><a id="Athletes-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Athletes.html">Athletes</a></li>\
                        <li><a id="Limited Editions-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Limited Editions.html">Limited Editions</a></li>\
                        <li><a id="My Account-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="My Account.html">My Account</a></li>\
                    </ul>\
    \
                </nav>\
    \
    ...
    \
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? \'max-height: \' + $refs.mobileNav.scrollHeight + \'px; opacity: 1\' : \'max-height: 0; opacity: .8\'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>\
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">\
                            ...
                            <li><a id="mobile-Events-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Events.html">Events</a></li>\
                            <li><a id="mobile-Athletes-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Athletes.html">Athletes</a></li>\
                            <li><a id="mobile-Limited Editions-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Limited Editions.html">Limited Editions</a></li>\
                            <li><a id="mobile-My Account-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="My Account.html">My Account</a></li>\
                        </ul>\
                    </nav>\
    \
                </div>\
